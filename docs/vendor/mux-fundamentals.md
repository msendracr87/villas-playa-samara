...
A reference for the core Mux concepts: organizations, environments, assets, playback IDs, live streams, and webhooks. Read this guide when you start with Mux or when you need a quick refresher.
...
Learn about access token priorities [here](https://www.mux.com/docs/core/make-api-requests#video-api).
...
**Learn more:** [Make API requests](https://www.mux.com/docs/core/make-api-requests) | [Use an SDK](https://www.mux.com/docs/core/sdks)
...
1. Downloads the file from your provided URL (or receives it via [direct upload](https://www.mux.com/docs/guides/upload-files-directly))
...
Rather than polling the API to check status, use [webhooks](https://www.mux.com/docs/core/listen-for-webhooks) to be notified when an asset is ready.

**Learn more:** [Stream videos in five minutes](https://www.mux.com/docs/core/stream-video-files) | [Assets APIAPI](https://www.mux.com/docs/api-reference/video/assets)
...
**Learn more:** [Play your videos](https://www.mux.com/docs/guides/play-your-videos) | [Secure video playback](https://www.mux.com/docs/guides/secure-video-playback)
...
**Learn more:** [Configure broadcast software](https://www.mux.com/docs/guides/configure-broadcast-software) | [Handle disconnections](https://www.mux.com/docs/guides/handle-live-stream-disconnects) | [Live Streams APIAPI](https://www.mux.com/docs/api-reference/video/live-streams)

## Signing keys

**Signing keys** are cryptographic key pairs used to generate JWTs (JSON Web Tokens) for [secure video playback](https://www.mux.com/docs/guides/secure-video-playback). When you have assets or live streams with `signed` playback policies, you need signing keys to create valid playback tokens.
...
**Learn more:** [Secure video playback](https://www.mux.com/docs/guides/secure-video-playback) | [Signing Keys APIAPI](https://www.mux.com/docs/api-reference/system/signing-keys)
...
**Learn more:** [Listen for webhooks](https://www.mux.com/docs/core/listen-for-webhooks) | [Verify webhook signatures](https://www.mux.com/docs/core/verify-webhook-signatures)
...
- [Node.js](https://www.mux.com/docs/integrations/mux-node-sdk)
- [Python](https://www.mux.com/docs/integrations/mux-python-sdk)
- [Ruby](https://www.mux.com/docs/integrations/mux-ruby-sdk)
- [PHP](https://www.mux.com/docs/integrations/mux-php-sdk)
- [Java](https://www.mux.com/docs/integrations/mux-java-sdk)
- [C# /.NET](https://www.mux.com/docs/integrations/mux-csharp-sdk)
- [Elixir](https://www.mux.com/docs/integrations/mux-elixir-sdk)

For client-side playback, see [Mux Player](https://www.mux.com/docs/guides/mux-player-web) and the various player SDK guides.

**Learn more:** [Use an SDK](https://www.mux.com/docs/core/sdks)
...
These are useful for generating API clients, importing into tools like [Postman](https://www.mux.com/docs/core/postman), validating webhook payloads, or integrating with any tooling that supports OpenAPI. Use the combined spec if you want everything in one file.
...
Upload your first video to Mux and play it back in your application.

[Read the guide](https://www.mux.com/docs/core/stream-video-files)

#### Listen for webhooks

Set up webhooks to receive real-time notifications when events occur.

[Read the guide](https://www.mux.com/docs/core/listen-for-webhooks)

#### Secure video playback

Learn how to protect your content with signed URLs and playback restrictions.

[Read the guide](https://www.mux.com/docs/guides/secure-video-playback)

Mux Developer ConsoleBETA
