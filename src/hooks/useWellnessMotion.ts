...
const motionSelector = "[data-wellness-motion]";

export function useWellnessMotion() {
  useLayoutEffect(() => {
    ...
    const stopMotion = () => {
      observer?.disconnect();
      observer = null;
      root.classList.remove("wellness-motion-ready");
    };
    ...
    const startMotion = () => {
      ...
      root.classList.add("wellness-motion-ready");
