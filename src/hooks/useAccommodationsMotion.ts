...
const motionSelector = "[data-accommodations-motion]";

export function useAccommodationsMotion() {
  useLayoutEffect(() => {
    ...
    const stopMotion = () => {
      observer?.disconnect();
      observer = null;
      root.classList.remove("accommodations-motion-ready");
    };
    ...
    const startMotion = () => {
      ...
      root.classList.add("accommodations-motion-ready");
